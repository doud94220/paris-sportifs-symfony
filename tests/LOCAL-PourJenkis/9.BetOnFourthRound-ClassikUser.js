...
async function runTest9(driver) {
    ...
    try {
        ...
        // ----------------------- Ne fonctionne pas dan avec S4.js -----------------------
        // console.log("35");
        // const validateBetsButton2 = await elementToBeClickable(driver, By.id('button-text'));
        // console.log("36");
        // await validateBetsButton2.click();
        // console.log("37");
