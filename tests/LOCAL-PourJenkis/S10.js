...
describe('S10', function () {
    ...
    it('should run Test 28 - Bet On SemiFinals as Admin', async function () {
        await runTest28(driver, BASE_URL);
    });
    ...
    it('should run Test 29 - Bet On SemiFinals as Classik User', async function () {
        await runTest29(driver, BASE_URL);
    });
