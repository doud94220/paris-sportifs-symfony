...
async function runTest19(driver, BASE_URL) {
    ...
    const optionElementMatch4 = await listPlayerOnelement_Match4.findElement(By.xpath("./option[normalize-space(text())='Hubert HURKACZ']"));
    await optionElementMatch4.click();
    console.log("23- L'option 'Hubert HURKACZ' a été sélectionnée avec succès.");
    const listSetNumberElement_Match4 = await driver.findElement(By.name('numberSetsBet_4'));
    const optionSetNumberElement_Match4 = await listSetNumberElement_Match4.findElement(By.xpath("./option[@value='5']"));
    ...
    console.log("29 - Classik user quarterfinal bets registered !");
}

module.exports = { runTest19 };