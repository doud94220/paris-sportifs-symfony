...
try {
    ...
    // //FAIRE CROIRE A MON SITE QUE C'EST PAS DE L'AUTOMATISATION
    // await driver.executeScript(() => {
    //     // Cette fonction s'exécute dans le contexte du navigateur.
    //     // Elle redéfinit la propriété 'webdriver' pour qu'elle renvoie 'undefined'.
    //     Object.defineProperty(navigator, 'webdriver', {
    //         get: () => undefined,
    //         configurable: true
    //     });
    // });
    // console.log("Le statut 'webdriver' a été masqué. Début de l'attente du contenu...");
    ...
    const URL_ADMIN_FOURTHROUND = 'http://127.0.0.1:8000/admin/fourthround';
    await driver.get(URL_ADMIN_FOURTHROUND);
    console.log("10 - Navigation forcée vers la page d'admin des 8èmes de finale");

    //Renseigner affiche 8ème finale - Premier 8ème
    const URL_ADMIN_FOURTHROUND_SHOWDONNS = 'http://127.0.0.1:8000/admin/fourthround-showdowns/1';
    ...
    const URL_ADMIN_FOURTHROUND_DEADLINE = 'http://127.0.0.1:8000/admin/fourthround-deadline';
