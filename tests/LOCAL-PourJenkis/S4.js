...
console.log("A");
const { runTest8 } = require('./8.BetOnFourthRound-Admin.js');
console.log("B");
const { runTest46 } = require('./46.AdminLogout.js');
console.log("C");
const { runTest4 } = require('./4.ConnectionAsClassikUser.js');
console.log("D");
const { runTest9 } = require('./9.BetOnFourthRound-ClassikUser.js');
console.log("E");
...
describe('S4', function () {
    ...
    it('should run Test 8 - Bet On Fourth Round as Admin', async function () {
        await runTest8(driver, BASE_URL);
        // await sleep(2000); // Ajoute un délai de 2 secondes
    });
    ...
    it('should run Test 9 - Bet On Fourth Round as classik user', async function () {
        await runTest9(driver, BASE_URL);
        // await sleep(2000); // Ajoute un délai de 2 secondes
    });
