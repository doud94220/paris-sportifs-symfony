...
async function runTest15(driver) {
    ...
    try {
        ...
        if (winnerPictureElementPathMatch5.includes('/img/Berrettini.png')) {
            console.log("26 - Correct picture path winner !");
        }
        else {
            console.log("26 - Incorrect picture path winner...");
        };
        ...
        if (winnerPictureElementPathMatch6.includes('/img/Ruud.png')) {
            console.log("30 - Correct picture path winner !");
        }
        else {
            console.log("30 - Incorrect picture path winner...");
        };
        ...
        if (winnerPictureElementPathMatch7.includes('/img/Hurkacz.png')) {
            console.log("34 - Correct picture path winner !");
        }
        else {
            console.log("34 - Incorrect picture path winner...");
        };
        ...
        console.log("36 - ALL THE MATCHS RESULT ARE FINE !!!");
    }
    catch (error) {
