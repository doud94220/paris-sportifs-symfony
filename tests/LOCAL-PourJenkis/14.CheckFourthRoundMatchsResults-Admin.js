...
async function runTest14(driver) {
    ...
    if (winnerPictureElementPathMatch1.includes('/img/Djokovic.png')) {
        ...
        console.log("5 - Incorrect picture path winner...");
    };
    ...
    if (winnerPictureElementPathMatch2.includes('/img/Federer.png')) {
        console.log("9 - Correct picture path winner !");
    }
    else {
    ...
    if (winnerPictureElementPathMatch3.includes('/img/Tsitsipas.png')) {
        ...
        console.log("15 - Incorrect picture path winner...");
    };
    ...
    if (winnerPictureElementPathMatch4.includes('/img/Thiem.png')) {
        console.log("19 - Correct picture path winner !");
    }
    else {
    ...
    if (winnerPictureElementPathMatch5.includes('/img/Berrettini.png')) {
        ...
        console.log("25 - Incorrect picture path winner...");
    };
    ...
    if (winnerPictureElementPathMatch6.includes('/img/Ruud.png')) {
        console.log("29 - Correct picture path winner !");
    }
    else {
        console.log("29 - Incorrect picture path winner...");
    };
    ...
    if (winnerPictureElementPathMatch7.includes('/img/Hurkacz.png')) {
        console.log("33 - Correct picture path winner !");
    }
    else {
        console.log("33 - Incorrect picture path winner...");
    };
    ...
    if (winnerPictureElementPathMatch8.includes('/img/AugerAliassime.png')) {
        console.log("37 - Correct picture path winner !");
    }
    else {
        console.log("37 - Incorrect picture path winner...");
    };
    ...
    console.log("39 - ALL THE MATCHS RESULT ARE FINE !!!");
}

module.exports = { runTest14 };
