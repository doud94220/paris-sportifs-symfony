...
console.log("A");
const { runTest16 } = require('./16.InsertQuarterFinalShowdownsAndDeadLine-Admin.js');
console.log("B");
...
describe('S6', function () {
    ...
    it('should run Test 16 - Insert Quarter Final Showdowns And Dead Line as Admin', async function () {
        await runTest16(driver, BASE_URL);
    });
