...
async function runTest8(driver) {
    ...
    try {
        ...
        const URL_BET_FOURTHROUND = 'http://127.0.0.1:8000/lets_bet/fourthround';
        ...
        const optionElementMatch4 = await listPlayerOnelement_Match4.findElement(By.xpath("./option[normalize-space(text())='Dominic THIEM']"));
        await optionElementMatch4.click();
        console.log("25- L'option 'Dominic THIEM' a été sélectionnée avec succès.");
        const listSetNumberElement_Match4 = await driver.findElement(By.name('numberSetsBet_4'));
        const optionSetNumberElement_Match4 = await listSetNumberElement_Match4.findElement(By.xpath("./option[@value='4']"));
        ...
        const optionElementMatch5 = await listPlayerOnelement_Match5.findElement(By.xpath("./option[normalize-space(text())='Matteo BERRETTINI']"));
        ...
        const optionSetNumberElement_Match5 = await listSetNumberElement_Match5.findElement(By.xpath("./option[@value='4']"));
        ...
        const optionElementMatch6 = await listPlayerOnelement_Match6.findElement(By.xpath("./option[normalize-space(text())='Casper RUUD']"));
        await optionElementMatch6.click();
        console.log("29- L'option 'Casper RUUD' a été sélectionnée avec succès.");
        ...
        const optionSetNumberElement_Match7 = await listSetNumberElement_Match7.findElement(By.xpath("./option[@value='3']"));
        ...
        const optionSetNumberElement_Match8 = await listSetNumberElement_Match8.findElement(By.xpath("./option[@value='5']"));
