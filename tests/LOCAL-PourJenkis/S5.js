...
describe('S5', function () {
    ...
    it('should run Test 10 - Insert Fourth Round Matchs Results', async function () {
        await runTest10(driver, BASE_URL);
    });

    it('should run Test 11 - Give Fourth Round Points', async function () {
        await runTest11(driver, BASE_URL);
    });

    it('should run Test 12 - Check Bettors Ranking After Fourth Round As Admin', async function () {
        await runTest12(driver, BASE_URL);
    });

    it('should run Test 14 - Check Fourth Round Matchs Results As Admin', async function () {
        await runTest14(driver, BASE_URL);
    });
    ...
    it('should run Test 4 - Connexion As Classik USer', async function () {
        await runTest4(driver, BASE_URL);
    });

    it('should run Test 13 - Check Bettors Ranking After Fourth Round As Classik User', async function () {
        await runTest13(driver, BASE_URL);
    });

    it('should run Test 15 - Check Fourth Round Matchs Results As Classik User', async function () {
        await runTest15(driver, BASE_URL);
    });
