...
console.log("A");
const { runTest26 } = require('./26.InsertSemiFinalsShowdownsAndDeadLine-Admin.js');
console.log("B");
...
describe('S9', function () {
    ...
    it('should run Test 26 - Insert SemiFinals Showdowns And DeadLine as Admin', async function () {
        await runTest26(driver, BASE_URL);
    });
