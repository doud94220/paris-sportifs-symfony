...
async function runTest37(driver, BASE_URL) {
    ...
    const URL_ADMIN_FINAL = `${BASE_URL}/admin/final?round=final`;
    ...
    const URL_ADMIN_FINAL_SHOWDONN = `${BASE_URL}/admin/final-showdown`;
    ...
    const URL_ADMIN_FINAL_DEADLINE = `${BASE_URL}/admin/final-deadline`;
