...
async function runTest10(driver) {
    ...
    try {
        ...
        console.log("7 - Forced navigation to fourth round results admin page");
        ...
        console.log("20 - Admin fourth round results match 1 registered !");
        ...
        console.log("22 - Admin fourth round results match 2 registered !");
        ...
        console.log("24 - Admin fourth round results match 3 registered !");
        ...
        console.log(`27 - Message succes : "${successMsgResultsScore_registration_match5}"`);
        ...
        console.log("28 - Admin fourth round results match 5 registered !");
        ...
        console.log(`29 - Message succes : "${successMsgResultsScore_registration_match6}"`);
        ...
        console.log("30 - Admin fourth round results match 6 registered !");
        ...
        console.log(`31 - Message succes : "${successMsgResultsScore_registration_match7}"`);
        ...
        console.log("32 - Admin fourth round results match 7 registered !");
        ...
        console.log(`33 - Message succes : "${successMsgResultsScore_registration_match8}"`);
        ...
        console.log("34 - Admin fourth round results match 8 registered !");
        ...
        console.log(`35 - Message succes : "${successMsgResultsScore_registration_allMatches}"`);
        ...
        console.log("36 - Admin fourth round results ALL MATCHES registered !");
    }
    catch (error) {
