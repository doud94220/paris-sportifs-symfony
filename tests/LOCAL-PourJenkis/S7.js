...
describe('S7', function () {
    ...
    it('should run Test 18 - Bet On Quarter Finals as Admin', async function () {
        await runTest18(driver, BASE_URL);
    });
    ...
    it('should run Test 4 - Connect as Admin', async function () {
        await runTest4(driver, BASE_URL);
    });

    it('should run Test 19 - Bet On Quarter Finals as Classik User', async function () {
        await runTest19(driver, BASE_URL);
    });
