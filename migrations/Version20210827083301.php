...
final class Version20210827083301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tennis_match (id INT AUTO_INCREMENT NOT NULL, player_one_id INT NOT NULL, player_two_id INT NOT NULL, round VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7510D177649A58CD (player_one_id), UNIQUE INDEX UNIQ_7510D177FC6BF02 (player_two_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
